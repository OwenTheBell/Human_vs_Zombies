...
namespace Human_vs_Zombies.HvZClasses
{
    public class HvZWorld
    {
        ...
        public HvZWorld()
        {
            m_Player = new Player(this, new Vector2(100f, 100f), new Vector2(1f,0f), 32f, new Vector2(1f,0f));
        ...
        public void SpawnZombie()
        {
            ...
            Zombie m_Zombie = new Zombie(this, position, Vector2.Zero, 32f, Vector2.Zero, 250f, new Random().NextDouble() < 0.5f ? (Brains)new SimpleAIBrains(this) : new ClusterAIBrains(this));
